...
export const WORKFLOW=[
 ...
 {id:'early',title:'04 术后2周',panes:[pane('week2','14天随访'),medication('术后7–30天'),{...pane('clinical','记录其他已有检验'),optional:true}]},
 {id:'month1',title:'05 术后1个月',panes:[pane('month1','1个月随访与30天并发症'),medication('术后7–30天')]},
 {id:'month3',title:'06 术后3个月',panes:[pane('month3','本次随访'),pane('qol','生活质量','3月'),medication('术后3个月')]},
 {id:'month6',title:'07 术后6个月',panes:[pane('month6','本次随访'),pane('qol','生活质量','6月'),pane('outcome','180天终点与结局'),medication('术后6个月')]},
 {id:'month12',title:'08 术后12个月',panes:[pane('month12','本次随访'),medication('术后12个月')]},
