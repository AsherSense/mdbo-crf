...
export function completeCase(i,arm='A'){
 ...
 add('random',{eligibility:'符合全部纳入标准，且无任何排除标准',stratum:i%4===0?'P':'NP',date:surgery,guidewire:'是',operator:'虚构测试执行人'+(i%3+1)});
 add('procedure',{conforms:'是',date:surgery,anesthesia:i%2?'镇静':'全麻',est:i%2?'EST（内镜乳头括约肌切开术）':'均未做',nasal:'否',stenosis:String(2+i/10),...procedurePlan(arm),stentModel:'虚构测试器械型号-'+i,length:i%2?'80':'60',technical:'是',complication:'无',clipModel:arm==='A'?'虚构测试夹型号':'NA',exposure:'7',deviation:''});
